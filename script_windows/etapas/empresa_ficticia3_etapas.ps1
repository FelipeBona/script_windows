    ...
    switch($opcao2){
        ...
        1{clear-host; & ".\commands\ucpd.ps1"; & ".\updates\ms_win_updates.ps1"; & ".\admin_users\empresa_ficticia3_users.ps1"; & ".\img\wallpaper.ps1" ; Write-Host "Será necessário reiniciar o computador para que alguns comandos da Etapa 2 funcione"; & ".\menu\aviso_hostname.ps1"; & ".\commands\restart.ps1"; Pause}
